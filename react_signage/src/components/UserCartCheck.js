    ...
    <div  style={{ display: 'flex', flexWrap: 'wrap' }}>
      {cartItems.map((item, index) => (
        <div key={index} style={{ width: '33%', padding: '10px' }}>
          <div style={{ backgroundColor: '#f8f8f8', width: '100%', height: '300px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '20px', borderRadius: '20px', boxShadow: "0px 4px 10px rgba(0, 0, 0, 5)"  }}>
